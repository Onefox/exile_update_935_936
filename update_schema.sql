...
ALTER TABLE `clan` 
ADD CONSTRAINT clan_ibfk_1 FOREIGN KEY(leader_uid) REFERENCES `account`(uid), 
...
ALTER TABLE `construction`
ADD CONSTRAINT construction_ibfk_1 FOREIGN KEY(account_uid) REFERENCES `account`(uid), 
ADD CONSTRAINT construction_ibfk_2 FOREIGN KEY(territory_id) REFERENCES `territory`(id), 
...
ALTER TABLE `container`
ADD CONSTRAINT container_ibfk_1 FOREIGN KEY(account_uid) REFERENCES `account`(uid), 
ADD CONSTRAINT container_ibfk_2 FOREIGN KEY(territory_id) REFERENCES `territory`(id), 
  ADD INDEX account_uid (account_uid), 
  ADD INDEX territory_id (territory_id), 
  ADD COLUMN territory_id int(11) unsigned NULL AFTER pin_code, 
...
ALTER TABLE `player`
ADD CONSTRAINT player_ibfk_1 FOREIGN KEY(account_uid) REFERENCES `account`(uid),
...
ALTER TABLE `territory`
ADD CONSTRAINT territory_ibfk_2 FOREIGN KEY(flag_stolen_by_uid) REFERENCES `account`(uid), 
ADD CONSTRAINT territory_ibfk_1 FOREIGN KEY(owner_uid) REFERENCES `account`(uid), 
...
ALTER TABLE `vehicle` 
ADD CONSTRAINT vehicle_ibfk_1 FOREIGN KEY(account_uid) REFERENCES `account`(uid), 
  ADD INDEX account_uid (account_uid), 
  ADD COLUMN last_updated_at datetime NOT NULL DEFAULT CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP AFTER cargo_container, 
  CHANGE COLUMN spawned_at spawned_at datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, 
